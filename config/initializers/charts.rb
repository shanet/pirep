Rails.configuration.sectional_charts = {
  ...
  # They are ordered in rows right to left from top-right (Halifax) to bottom-left (Brownsville).
  halifax: {
    archive: 'Halifax.zip',
  ...
  # Alaska
  #
  # The same ordering rules as above for the continential US apply here
  point_barrow: {
